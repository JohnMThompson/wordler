...
- **Stats view:** success rate, streaks, a high-resolution Braille chart of the cumulative average solve across the latest 25 solved games, plus bar-chart distribution and per-outcome percentages:
  - solved in 1
  - solved in 2
  - solved in 3
  - solved in 4
